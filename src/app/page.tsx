  ...
  return (
    <div>
      ...
      <section style={{ padding: '100px 48px 80px', maxWidth: '1100px', margin: '0 auto', textAlign: 'center', position: 'relative' }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 'clamp(3.5rem, 9vw, 7rem)', lineHeight: 1.0, color: 'var(--text)', marginBottom: '4px', letterSpacing: '-0.03em' }}>
          Write once.
        </h1>
        <h1 style={{ fontFamily: 'var(--font-display)', fontStyle: 'italic', fontWeight: 700, fontSize: 'clamp(3.5rem, 9vw, 7rem)', lineHeight: 1.0, color: 'var(--accent)', marginBottom: '44px', letterSpacing: '-0.03em' }}>
          Own forever.
        </h1>
